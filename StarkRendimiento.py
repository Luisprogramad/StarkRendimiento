...
# --- SECCIÓN 3: BILLETERA Y COBROS ---
    ...
    metodo = st.radio(
        ...
        [
            ...
            "🌐 Tarjeta Internacional / Pasarela NOWPayments"
        ]
    )
    ...
    if "CVU / Pesos" in metodo:
        ...
        st.warning("⚠️ *Nota: Si el cliente usa tarjeta de crédito argentina en esta pasarela, su banco aplicará recargos internacionales.*")
            ...
            if not NOWPAYMENTS_API_KEY:
                ...
                with st.spinner("Generando enlace..."):
                    ...
                    if url_pago:
                        ...
                        st.image(qr_bytes, caption="Escanear para pagar", width=250)
                        st.markdown(f"🔗 [Enlace de pago]({url_pago})")
